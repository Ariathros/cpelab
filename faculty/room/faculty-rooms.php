<?php
	...
	$record_count = mysqli_query($conn, "SELECT COUNT(*) AS total_records FROM room_man WHERE status='Approved'") or die(mysqli_error($conn));
	// total records
	...
	// sql query
	$sql = "SELECT * FROM room_man WHERE status='Approved' LIMIT $offset , $record_per_page";
	// result
